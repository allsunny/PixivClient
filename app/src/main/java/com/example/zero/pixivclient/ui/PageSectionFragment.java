...
import com.example.zero.pixivclient.Jsoup.JsoupTool;
import com.example.zero.pixivclient.R;
import com.example.zero.pixivclient.model.ImageInfo;
import com.example.zero.pixivclient.utils.RefreshUtil;
import com.example.zero.pixivclient.utils.Validator;
    ...
    public class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                view.setTag(viewHolder);   //防止ListView图片错乱
            } else {
                viewHolder = (ViewHolder) view.getTag();
            }

            final ImageInfo imgInfo = imgList.get(position);
            String title = imgInfo.getImageTitle();
            String imgUrl = imgInfo.getImageUrl();
